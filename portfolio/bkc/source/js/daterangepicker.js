...
(function(root, factory) {
  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges_cnt">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<div class="daterangepicker-button"><button class="applyBtn" disabled="disabled"></button>&nbsp;' +
                    '<button class="cancelBtn"></button></div>' +
                  '</div>' +
                '</div>' +
                '</div>' +
                '<div class="calendar_cnt cf">' +
        ...
        this.container.find('.applyBtn').html(this.locale.applyLabel+"<i></i>");
        this.container.find('.cancelBtn').html(this.locale.cancelLabel+"<i></i>");
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            if (typeof options.ranges === 'object') {
                ...
                this.container.find('.ranges_cnt').prepend(list);
            }
